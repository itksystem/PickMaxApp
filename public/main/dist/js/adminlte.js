...
(function (global, factory) {
  ...
  var ControlSidebar = /*#__PURE__*/function () {
    ...
    _proto.collapse = function collapse() {
      ...
      if (this._config.controlsidebarSlide) {
        ...
        $body.removeClass(CLASS_NAME_CONTROL_SIDEBAR_SLIDE).delay(30).queue(function () {
    ...
    _proto.show = function show() {
      ...
      if (this._config.controlsidebarSlide) {
        ...
        $__default['default'](SELECTOR_CONTROL_SIDEBAR).show().delay(10).queue(function () {
          $body.addClass(CLASS_NAME_CONTROL_SIDEBAR_SLIDE).delay(30).queue(function () {
            $html.removeClass(CLASS_NAME_CONTROL_SIDEBAR_ANIMATE);
            $__default['default'](this).dequeue();
          });
          $__default['default'](this).dequeue();
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, params, uniqueName, autoOpen) {
      console.log('createTab');
      var _this = this;

//      var tabId = "panel-" + uniqueName + "-" + Math.floor(Math.random() * 1000);
      var tabId = "output-main-panel";
...
//    var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link +"\\"+params+ "\"></iframe></div>";
//    var newTabItem = "<div class=\"tab-pane \" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\"></iframe></div>";
      var newTabItem = "<div class=\"tab-pane \" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"></div>";
	$(".loading").show();
	$.ajax({
	  url: link,
 	  cache: false,
	  ...
	  success: function(o){ // если запрос успешен вызываем функцию
		...
		$('div.navbar').hide();		// отключили панель переключения окон из-за ненадобности  
		$("#output-main-panel").show(); // принудительно включаем из-за отключенного     $__default['default'](SELECTOR_TAB_NAVBAR_NAV).append(newNavItem);
		$(".loading").hide();
	  }
	}).done(
      function() {}
...
//    Исправлен вызов 
      var params = document.getElementById('selectedGroup').options[document.getElementById('selectedGroup').selectedIndex].value;
     ...
     this.createTab(title, link, params,link.replace('.html', '').replace('./', '').replaceAll('/', '-'), autoOpen);
    };
    ...
    _proto._setupListeners = function _setupListeners() {
      ...
      $__default['default'](document).on('click', SELECTOR_SIDEBAR_MENU_ITEM, function (e) {
        e.preventDefault();
 	 console.log(SELECTOR_SIDEBAR_MENU_ITEM);
      ...
      if (this._config.useNavbarItems) {
        $__default['default'](document).on('click', SELECTOR_HEADER_MENU_ITEM + ", " + SELECTOR_HEADER_DROPDOWN_ITEM, function (e) {
          e.preventDefault();
   	   console.log('SELECTOR_HEADER_MENU_ITEM =>'+SELECTOR_HEADER_MENU_ITEM);
          _this2.openTabSidebar(e.target);
        });
 	 ...
 	 console.log(SELECTOR_TAB_NAVBAR_NAV_ITEM);
        e.preventDefault();
	 ...
	 console.log('SELECTOR_DATA_TOGGLE_CLOSE');
        e.preventDefault();
        _this2.removeActiveTab();
      });
      $__default['default'](document).on('click', SELECTOR_DATA_TOGGLE_FULLSCREEN, function (e) {
	 console.log('SELECTOR_DATA_TOGGLE_FULLSCREEN');
        e.preventDefault();
