...
const COMMON_CONNFIRMATION_EMAIL_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // 
const COMMON_CONNFIRMATION_PHONE_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // 
const COMMON_BALANCE_DEPOSIT_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // 
const COMMON_BALANCE_HISTORY_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // 
const COMMON_PINCODE_LOGON_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // 
...
// 20.11.2024
const COMMON_PAYMENT_PAGE = path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // Путь до страницы оплаты товара

// 01.01.2025
const COMMON_GET_REVIEWS_PAGE= path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // Путь до страницы оплаты товара

// 08.01.2025
const COMMON_GET_MAILS_PAGE= path.join(COMMON_PATH_TO_PAGES, 'app.hbs'); // Путь до страницы оплаты товара
...
COMMON_PAYMENT_PAGE,
COMMON_GET_REVIEWS_PAGE,
COMMON_GET_MAILS_PAGE,
COMMON_CONNFIRMATION_EMAIL_PAGE,
COMMON_CONNFIRMATION_PHONE_PAGE,
COMMON_BALANCE_DEPOSIT_PAGE,
COMMON_BALANCE_HISTORY_PAGE,
COMMON_PINCODE_LOGON_PAGE,
};
