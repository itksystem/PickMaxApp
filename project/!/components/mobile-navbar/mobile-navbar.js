  ...
  class MobileNavbar extends HTMLElement {
    constructor() {
      ...
      linkElem.setAttribute('href', '/css/mobile-navbar.css');
  ...
  class MobileNavbarItem extends HTMLElement {
    constructor() {
      ...
      const linkElem = document.createElement('link');
      linkElem.setAttribute('rel', 'stylesheet');
      linkElem.setAttribute('href', '/css/mobile-navbar-item.css');
      shadow.appendChild(linkElem);

      const linkElemFont = document.createElement('link');
      linkElemFont.setAttribute('rel', 'stylesheet');
      linkElemFont.setAttribute('href', '/plugins/fontawesome-free/css/all.min.css');
