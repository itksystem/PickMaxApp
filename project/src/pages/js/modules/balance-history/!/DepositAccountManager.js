class DepositAccountManager {
    ...
    createDepositSection(data) {
        // Секция для карт
//	 let CardSection =  DOMHelper.createDropdownSection("Зачисление средств", this.getElements() || []);
	 let CardSection =  DOMHelper.createDropdownSection("Зачисление средств",  []);
	 return CardSection;
    }
