    ...
    createGroupElement(group, onTransactionClick) {
        ...
        header.innerHTML = `
            ...
            <div class="group-totals row">
                <div class="income col-4">Доход: ${this.formatAmount(group.income)}</div>
                <div class="expense col-4">Расход: ${this.formatAmount(group.expense)}</div>
                <div class="balance col-4">Итого: ${this.formatAmount(group.income + group.expense)}</div>
            </div>
        `;
