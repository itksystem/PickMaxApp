class OrderItem {
	...
	<section class="page-padding block-space card1 ">
	      <div class="row">		
		     ...
		     <span class="${this.common.ORDER_STATUS[item.status].class}" style="padding:0.3rem;font-size: 0.8rem;">${this.common.ORDER_STATUS[item.status].description}</span>		
                </div>
               </div>
			 ...
			 <div class="col-3  col-sm-3 col-md-3 text-left" >		
			      <div class="row">		
	        		<div class="col-12 col-sm-6 text-left">
				     <span style="font-size: 0.8rem">№ ${item.orderId}</span>		   
			         </div>
		         	 <div class="col-12 col-sm-6 text-left">		
				     ...
				     <span style="font-size: 0.8rem">${item.itemsCount} шт.</span>		
        		        </div>
		                <div class="col-3 col-sm-2 col-md-1  text-start" >
				     <span style="font-size: 0.8rem">${item.totalAmount} ₽</span>		
        		        </div>
               			<div class="col-4  col-sm-4 col-md-4 text-end">
					  <a href="/orders/${item.orderId}/page" style="font-size: 0.8rem;"> Перейти к заказу </a>		
	        	        </div>
           </div>
	</section>
   `;
