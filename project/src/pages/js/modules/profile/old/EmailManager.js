class EmailManager {
    ...
    createEmailSection(data) {
        ...
        const emailStatusText = isEmailConfirmed ? `Email подтвержден` : `Email необходимо подтвердить!`;
        ...
        const emailSection = DOMHelper.createDropdownSection("Электронный адрес", [
            ...
            DOMHelper.createConfirmationLabel(emailStatusText, emailStatusClass),
    ...
    async saveEmailButtonOnClick() {
        try {
            ...
            this.getEmailButton().textContent = this.EMAIL_CONFIRM_ACTION_DESCRIPTION;
