class ChangeSecurityQuestionPageSection extends PageBuilder {
    ...
    initManagers() { // Централизованная инициализация менеджеров
        this.managers = {
            SecurityQuestion: new ChangeSecurityQuestionManager(this),
        };
    }

    ChangeSecurityQuestionCardContainer(data = null) {
    ...
    createHeader() {
        return DOMHelper.createElement("div", "card-header", `
            <h3 class="card-title">Установка контрольного вопроса</h3>
        `);
    }
